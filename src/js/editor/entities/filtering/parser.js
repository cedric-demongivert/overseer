...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$startRuleFunctions = { Filter: peg$parseFilter },
        peg$startRuleFunction  = peg$parseFilter,

        peg$c0 = function(disjunction) { return disjunction },
        peg$c1 = ",",
        peg$c2 = peg$literalExpectation(",", false),
        peg$c3 = function(first, elements) {
        ...
        peg$c5 = function(assertion) { return assertion },
        peg$c6 = "not:",
        peg$c7 = peg$literalExpectation("not:", false),
        peg$c8 = function(assertion) {
    ...
    function peg$parseAssertion() {
      ...
      if (s1 === peg$FAILED) {
        s1 = peg$parseTextAssertion();
        if (s1 === peg$FAILED) {
          s1 = peg$parseNumericAssertion();
          if (s1 === peg$FAILED) {
            s1 = peg$parseWordAssertion();
          }
        }
      }
      if (s1 !== peg$FAILED) {
    ...
    function peg$parseWordAssertion() {
      var s0, s1, s2;
    ...
    function peg$parseTextAssertion() {
      var s0, s1, s2, s3;
    ...
    function peg$parseNumericAssertion() {
      var s0, s1;

      s0 = peg$currPos;
      s1 = peg$parseRangeAssertion();
      if (s1 === peg$FAILED) {
        s1 = peg$parseSingleNumberAssertion();
      }
      if (s1 !== peg$FAILED) {
        peg$savedPos = s0;
        s1 = peg$c19(s1);
    ...
    function peg$parseSingleNumberAssertion() {
      var s0, s1, s2;
    ...
    function peg$parseRangeAssertion() {
      var s0, s1, s2, s3, s4;
