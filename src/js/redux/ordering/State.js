...
export class State extends new Record({
  ...
  *
  * @param {State} toCopy - An ordering instance to copy.
  *
  * @return {State} A new instance that is a copy of the given instance.
  */
  static copy (toCopy) {
    return new State(toCopy)
  }

  /**
  * Create a new ordering.
  *
  * @param {number[]} [state = []] - Initial ordering state.
  */
  static create (state = []) {
    if (state == null || state.length <= 1) return new State()
  ...
  *
  * @param {number} field - The identifier of the field to get.
  *
  * @return {Direction} The ordering direction of the given field.
  */
  ...
  *
  * @param {number} field - The identifier of the field to keep.
  *
  * @return {State} A new updated ordering structure.
  */
  only (field) {
    return State.DEFAULT.orderBy(field, this.getDirectionOfField(field))
  }
  ...
  *
  * @param {number} field - The identifier of the field to order.
  * @return {State} An updated instance of this configuration.
  */
  ascending (field) {
  ...
  *
  * @return {State} A new empty ordering configuration.
  */
  clear () {
