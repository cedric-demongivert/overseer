import matrix4us from './raw/matrix4us'

export class Matrix4us {
  /**
  * Create a new 4 by 4 unsigned short matrix with initial content.
  *
  * @param {...number} content - Content of new 4 by 4 unsigned short matrix in row-major order.
  *
  * @return {Matrix4us} A new 4 by 4 unsigned short matrix with the given initial content.
  */
  static create (
    a00, a10, a20, a30,
    a01, a11, a21, a31,
    ...
    const result = new Matrix4us().set(
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
      a03, a13, a23, a33
  ...
  /**
  * Wrap a Uint16Array as a 4 by 4 unsigned short matrix.
  *
  * @param {Uint16Array} buffer - A buffer to wrap.
  *
  * @return {Matrix4us} A new 4 by 4 unsigned short matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix4us(buffer)
  }

  /**
  * Clone a Uint16Array as a 4 by 4 unsigned short matrix instance and return the result.
  *
  * @param {Matrix4us} toClone - A 4 by 4 unsigned short matrix instance to clone.
  *
  * @return {Matrix4us} A new 4 by 4 unsigned short matrix that wrap the given buffer.
  */
  static clone (toClone) {
    const result = new Matrix4us()
  ...
  /**
  * Wrap a Uint16Array as a 4 by 4 matrix.
  *
  * @param {Uint16Array} [buffer = new Uint16Array(16)] - A buffer to wrap.
  */
  constructor (buffer = new Uint16Array(16)) {
    this._buffer = buffer
  }
  ...
  */
  get determinant () {
    return matrix4us.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix4us} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 4 by 4 unsigned short matrix in row-major order.
  *
  * @return {Matrix4us} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix4us} toCopy - Matrix instance to copy.
  *
  * @return {Matrix4us} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix4us.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix4us.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix4us} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4us} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix4us.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix4us.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix4us.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix4us} left - Left operand matrix.
  * @param {Matrix4us} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4us} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix4us.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix4us.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix4us.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  * @param {Vector4us} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4us} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix4us.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix4us.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix4us.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix4us.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix4us.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix4us.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y, z, w) {
    matrix4us.toScale(this._buffer, 0, x, y, z, w)
    return this
  }
  ...
  */
  toRotation (x, y, z) {
    matrix4us.toRotation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toTranslation (x, y, z) {
    matrix4us.toTranslation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  *
  * @param {Vector4us} result - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4us} The updated instance of this matrix for chaining purpose.
  */
  extractScale (result) {
    matrix4us.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Vector3us} result - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4us} The updated instance of this matrix for chaining purpose.
  */
  extractTranslation (result) {
    matrix4us.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix4us.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix4us} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix4us.toString(this._buffer, 0)
  }
}