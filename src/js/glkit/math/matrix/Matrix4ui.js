import matrix4ui from './raw/matrix4ui'

export class Matrix4ui {
  /**
  * Create a new 4 by 4 unsigned integer matrix with initial content.
  *
  * @param {...number} content - Content of new 4 by 4 unsigned integer matrix in row-major order.
  *
  * @return {Matrix4ui} A new 4 by 4 unsigned integer matrix with the given initial content.
  */
  static create (
    a00, a10, a20, a30,
    a01, a11, a21, a31,
    ...
    const result = new Matrix4ui().set(
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
      a03, a13, a23, a33
  ...
  /**
  * Wrap a Uint32Array as a 4 by 4 unsigned integer matrix.
  *
  * @param {Uint32Array} buffer - A buffer to wrap.
  *
  * @return {Matrix4ui} A new 4 by 4 unsigned integer matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix4ui(buffer)
  }

  /**
  * Clone a Uint32Array as a 4 by 4 unsigned integer matrix instance and return the result.
  *
  * @param {Matrix4ui} toClone - A 4 by 4 unsigned integer matrix instance to clone.
  *
  * @return {Matrix4ui} A new 4 by 4 unsigned integer matrix that wrap the given buffer.
  */
  static clone (toClone) {
    const result = new Matrix4ui()
  ...
  /**
  * Wrap a Uint32Array as a 4 by 4 matrix.
  *
  * @param {Uint32Array} [buffer = new Uint32Array(16)] - A buffer to wrap.
  */
  constructor (buffer = new Uint32Array(16)) {
    this._buffer = buffer
  }
  ...
  */
  get determinant () {
    return matrix4ui.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix4ui} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 4 by 4 unsigned integer matrix in row-major order.
  *
  * @return {Matrix4ui} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix4ui} toCopy - Matrix instance to copy.
  *
  * @return {Matrix4ui} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix4ui.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix4ui.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix4ui} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4ui} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix4ui.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix4ui.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix4ui.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix4ui} left - Left operand matrix.
  * @param {Matrix4ui} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4ui} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix4ui.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix4ui.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix4ui.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  * @param {Vector4ui} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4ui} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix4ui.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix4ui.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix4ui.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix4ui.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix4ui.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix4ui.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y, z, w) {
    matrix4ui.toScale(this._buffer, 0, x, y, z, w)
    return this
  }
  ...
  */
  toRotation (x, y, z) {
    matrix4ui.toRotation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toTranslation (x, y, z) {
    matrix4ui.toTranslation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  *
  * @param {Vector4ui} result - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4ui} The updated instance of this matrix for chaining purpose.
  */
  extractScale (result) {
    matrix4ui.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extractTranslation (result) {
    matrix4ui.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix4ui.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix4ui} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix4ui.toString(this._buffer, 0)
  }
}