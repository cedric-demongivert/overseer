import matrix3d from './raw/matrix3d'

export class Matrix3d {
  /**
  * Create a new 3 by 3 double matrix with initial content.
  *
  * @param {...number} content - Content of new 3 by 3 double matrix in row-major order.
  *
  * @return {Matrix3d} A new 3 by 3 double matrix with the given initial content.
  */
  static create (
    a00, a10, a20,
    a01, a11, a21,
  ...
  *
  * @return {Matrix3d} A new 3 by 3 double matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix3d(buffer)
  }

  /**
  * Clone a Float64Array as a 3 by 3 double matrix instance and return the result.
  *
  * @param {Matrix3d} toClone - A 3 by 3 double matrix instance to clone.
  *
  * @return {Matrix3d} A new 3 by 3 double matrix that wrap the given buffer.
  */
  ...
  *
  * @param {Float64Array} [buffer = new Float64Array(9)] - A buffer to wrap.
  */
  ...
  */
  get determinant () {
    return matrix3d.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix3d} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 3 by 3 double matrix in row-major order.
  *
  * @return {Matrix3d} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix3d} toCopy - Matrix instance to copy.
  *
  * @return {Matrix3d} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix3d.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix3d.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix3d} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix3d} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix3d.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix3d.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix3d.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix3d} left - Left operand matrix.
  * @param {Matrix3d} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix3d} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix3d.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix3d.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10, a20,
      a01, a11, a21,
      a02, a12, a22
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix3d.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10, a20,
      a01, a11, a21,
      a02, a12, a22
  ...
  * @param {Vector3d} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix3d} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix3d.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix3d.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix3d.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix3d.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix3d.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix3d.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y, z) {
    matrix3d.toScale(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toRotation (x, y, z) {
    matrix3d.toRotation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toTranslation (x, y) {
    matrix3d.toTranslation(this._buffer, 0, x, y)
    return this
  }
  ...
  */
  extractScale (result) {
    matrix3d.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extractTranslation (result) {
    matrix3d.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix3d.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix3d} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix3d.toString(this._buffer, 0)
  }
}