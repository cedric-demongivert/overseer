import matrix4ub from './raw/matrix4ub'

export class Matrix4ub {
  /**
  * Create a new 4 by 4 unsigned byte matrix with initial content.
  *
  * @param {...number} content - Content of new 4 by 4 unsigned byte matrix in row-major order.
  *
  * @return {Matrix4ub} A new 4 by 4 unsigned byte matrix with the given initial content.
  */
  static create (
    a00, a10, a20, a30,
    a01, a11, a21, a31,
    ...
    const result = new Matrix4ub().set(
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
      a03, a13, a23, a33
  ...
  /**
  * Wrap a Uint8Array as a 4 by 4 unsigned byte matrix.
  *
  * @param {Uint8Array} buffer - A buffer to wrap.
  *
  * @return {Matrix4ub} A new 4 by 4 unsigned byte matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix4ub(buffer)
  }

  /**
  * Clone a Uint8Array as a 4 by 4 unsigned byte matrix instance and return the result.
  *
  * @param {Matrix4ub} toClone - A 4 by 4 unsigned byte matrix instance to clone.
  *
  * @return {Matrix4ub} A new 4 by 4 unsigned byte matrix that wrap the given buffer.
  */
  static clone (toClone) {
    const result = new Matrix4ub()
  ...
  /**
  * Wrap a Uint8Array as a 4 by 4 matrix.
  *
  * @param {Uint8Array} [buffer = new Uint8Array(16)] - A buffer to wrap.
  */
  ...
  */
  get determinant () {
    return matrix4ub.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix4ub} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 4 by 4 unsigned byte matrix in row-major order.
  *
  * @return {Matrix4ub} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix4ub} toCopy - Matrix instance to copy.
  *
  * @return {Matrix4ub} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix4ub.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix4ub.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix4ub} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4ub} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix4ub.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix4ub.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix4ub.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix4ub} left - Left operand matrix.
  * @param {Matrix4ub} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4ub} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix4ub.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix4ub.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix4ub.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  * @param {Vector4ub} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4ub} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix4ub.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix4ub.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix4ub.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix4ub.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix4ub.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix4ub.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y, z, w) {
    matrix4ub.toScale(this._buffer, 0, x, y, z, w)
    return this
  }
  ...
  */
  toRotation (x, y, z) {
    matrix4ub.toRotation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toTranslation (x, y, z) {
    matrix4ub.toTranslation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  *
  * @param {Vector4ub} result - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4ub} The updated instance of this matrix for chaining purpose.
  */
  extractScale (result) {
    matrix4ub.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extractTranslation (result) {
    matrix4ub.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix4ub.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix4ub} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix4ub.toString(this._buffer, 0)
  }
}