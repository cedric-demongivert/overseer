...
* @param {number} w - Scale factor of the w axis.
*
* @return {Float64Array} The buffer, updated with the content of a 4 dimensional scale matrix.
*/
...
* @param {number} z - Translation to apply to the z axis.
*
* @return {Float64Array} The buffer, updated with the content of a 3 dimensional translation matrix.
*/
...
*
* @return {number} The determinant of the given 4 by 4 double buffered matrix.
*/
...
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Float64Array} The result buffer updated with the content of the 4 dimensional scale vector extracted from the given matrix.
*/
