...
* @param {number} z - Scale factor of the z axis.
*
* @return {Int32Array} The buffer, updated with the content of a 3 dimensional scale matrix.
*/
...
* @param {number} y - Translation to apply to the y axis.
*
* @return {Int32Array} The buffer, updated with the content of a 2 dimensional translation matrix.
*/
...
*
* @return {number} The determinant of the given 3 by 3 integer buffered matrix.
*/
...
/**
* Invert a 3 by 3 integer buffered matrix and write the result into another buffer.
*
* @param {Int32Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
...
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Int32Array} The result buffer updated with the content of the 3 dimensional scale vector extracted from the given matrix.
*/
