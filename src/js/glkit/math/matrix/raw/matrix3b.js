/**
* Transform a 3 by 3 byte buffered matrix into a string.
*
...
export function toString (
  ...
  if (matrixBuffer == null) {
    return 'matrix 3 by 3 byte null'
  } else {
    return [
      `matrix 3 by 3 byte `,
      '[',
...
/**
* Fill a 3 by 3 byte buffered matrix with a given value.
*
...
/**
* Compare two 3 by 3 byte buffered matrix and return true if they are both equals.
*
...
/**
* Set the content of a 3 by 3 byte buffered matrix.
*
...
/**
* Copy the content of a 3 by 3 byte buffered matrix into another.
*
...
/**
* Transpose a 3 by 3 byte buffered matrix and put the result into another buffer.
*
...
/**
* Multiply 3 by 3 byte buffered matrix with another and put the result into a third buffer.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
...
/**
* Multiply a 3 by 3 byte buffered matrix with another static matrix, the buffered matrix will be used as a left operand.
*
...
/**
* Multiply 3 by 3 byte buffered matrix with a 3 byte buffered vector and put the result into a third buffer.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the left operand matrix.
* @param {number} matrixBufferOffset - Offset to apply when we read the first buffer.
...
/**
* Multiply a 3 by 3 byte buffered matrix with a scalar and put the result into another buffer.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
...
/**
* Negate a 3 by 3 byte buffered matrix and put the result into another buffer.
*
...
/**
* Divide a 3 by 3 byte buffered matrix with a scalar and put the result into another buffer.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {number} scalar - Scalar to use as right operand.
...
/**
* Apply a 3 dimensional scale to a 3 by 3 byte buffered matrix and put the result into another buffer.
*
...
/**
* Apply a 3 dimensional rotation to a 3 by 3 byte buffered matrix and put the result into another buffer.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Apply a 2 dimensional translation to a 3 by 3 byte buffered matrix and put the result into another buffer.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Add a 3 by 3 byte buffered matrix to another one and put the result into a third buffer.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {Int8Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Subtract a 3 by 3 byte buffered matrix to one and put the result into a third buffer.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {Int8Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Set the content of a 3 by 3 byte buffered matrix to the content of an identity matrix.
*
...
/**
* Set the content of a 3 by 3 byte buffered matrix to the content of a 3 dimensional scale matrix.
*
* @param {Int8Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
* @param {number} x - Scale factor of the x axis.
...
* @param {number} z - Scale factor of the z axis.
*
* @return {Int8Array} The buffer, updated with the content of a 3 dimensional scale matrix.
*/
...
/**
* Set the content of a 3 by 3 byte buffered matrix to a 3 dimensional rotation.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
* @param {number} x - Rotation for the x axis in radians.
...
* @param {number} z - Rotation for the z axis in radians.
*
* @return {Int8Array} The buffer, updated with the content of a 3 dimensional rotation.
*/
...
/**
* Set the content of a 3 by 3 byte buffered matrix to the content of a 2 dimensional translation matrix.
*
* @param {Int8Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
* @param {number} x - Translation to apply to the x axis.
* @param {number} y - Translation to apply to the y axis.
*
* @return {Int8Array} The buffer, updated with the content of a 2 dimensional translation matrix.
*/
...
/**
* Compute and return the determinant of a 3 by 3 byte buffered matrix.
*
* @param {Int8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
*
* @return {number} The determinant of the given 3 by 3 byte buffered matrix.
*/
...
/**
* Invert a 3 by 3 byte buffered matrix and write the result into another buffer.
*
* @param {Int8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Int8Array} resultBuffer - Buffer to write.
...
/**
* Extract a translation from a 3 by 3 byte buffered matrix
*
* @param {Int8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Int8Array} resultBuffer - Buffer to write.
...
/**
* Extract a scale from a 3 by 3 byte buffered matrix
*
* @param {Int8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Int8Array} resultBuffer - Buffer to write.
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Int8Array} The result buffer updated with the content of the 3 dimensional scale vector extracted from the given matrix.
*/
...
/**
* Extract a 2D rotation from a 3 by 3 byte buffered matrix
*
* @param {Int8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
*
