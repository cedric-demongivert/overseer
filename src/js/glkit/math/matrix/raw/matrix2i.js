...
* @param {number} y - Scale factor of the y axis.
*
* @return {Int32Array} The buffer, updated with the content of a 2 dimensional scale matrix.
*/
...
* @param {number} y - Rotation for the y axis in radians.
*
* @return {Int32Array} The buffer, updated with the content of a 2 dimensional rotation.
*/
...
* @param {number} x - Translation to apply to the x axis.
*
* @return {Int32Array} The buffer, updated with the content of a 1 dimensional translation matrix.
*/
...
*
* @return {number} The determinant of the given 2 by 2 integer buffered matrix.
*/
...
/**
* Invert a 2 by 2 integer buffered matrix and write the result into another buffer.
*
* @param {Int32Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
...
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Int32Array} The result buffer updated with the content of the 2 dimensional scale vector extracted from the given matrix.
*/
