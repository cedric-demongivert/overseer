/**
* Transform a 2 by 2 byte buffered matrix into a string.
*
* @param {Int8Array} matrixBuffer - The buffer that contains the matrix to transform.
...
export function toString (
  ...
  if (matrixBuffer == null) {
    return 'matrix 2 by 2 byte null'
  } else {
    return [
      `matrix 2 by 2 byte `,
      '[',
...
/**
* Fill a 2 by 2 byte buffered matrix with a given value.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the matrix to fill.
...
*
* @return {Int8Array} The buffer with the updated matrix.
*/
...
/**
* Compare two 2 by 2 byte buffered matrix and return true if they are both equals.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the buffer that contains the left operand matrix.
* @param {Int8Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Set the content of a 2 by 2 byte buffered matrix.
*
* @param {Int8Array} buffer - Buffer to mutate.
...
*
* @return {Int8Array} The buffer, updated with the given data.
*/
export function set (
  buffer,
  bufferOffset,
...
/**
* Copy the content of a 2 by 2 byte buffered matrix into another.
*
* @param {Int8Array} sourceBuffer - Buffer to read.
* @param {number} sourceBufferOffset - Offset to apply when we read the source buffer.
* @param {Int8Array} destinationBuffer - Buffer to write.
* @param {number} destinationBufferOffset - Offset to apply when we write into the destination buffer.
*
* @return {Int8Array} The destination buffer, updated with the source data.
*/
...
/**
* Transpose a 2 by 2 byte buffered matrix and put the result into another buffer.
*
* @param {Int8Array} matrixBuffer - Buffer to read.
...
*
* @return {Int8Array} The destination buffer, updated with the transposed matrix readed from the source buffer.
*/
...
/**
* Multiply 2 by 2 byte buffered matrix with another and put the result into a third buffer.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
...
* @param {number} resultBufferOffset - Offset to apply when we write into the destination buffer.
*
* @return {Int8Array} The destination buffer, updated with the result of the operation.
*/
...
/**
* Multiply a 2 by 2 byte buffered matrix with another static matrix, the buffered matrix will be used as a left operand.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the left operand matrix.
...
/**
* Multiply 2 by 2 byte buffered matrix with a 2 byte buffered vector and put the result into a third buffer.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the left operand matrix.
* @param {number} matrixBufferOffset - Offset to apply when we read the first buffer.
* @param {Int8Array} vectorBuffer - Buffer that contains the right operand vector.
...
/**
* Multiply a 2 by 2 byte buffered matrix with a scalar and put the result into another buffer.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
...
/**
* Negate a 2 by 2 byte buffered matrix and put the result into another buffer.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the matrix.
...
/**
* Divide a 2 by 2 byte buffered matrix with a scalar and put the result into another buffer.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {number} scalar - Scalar to use as right operand.
...
/**
* Apply a 2 dimensional scale to a 2 by 2 byte buffered matrix and put the result into another buffer.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Apply a 2 dimensional rotation to a 2 by 2 byte buffered matrix and put the result into another buffer.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Apply a 1 dimensional translation to a 2 by 2 byte buffered matrix and put the result into another buffer.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Add a 2 by 2 byte buffered matrix to another one and put the result into a third buffer.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {Int8Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Subtract a 2 by 2 byte buffered matrix to one and put the result into a third buffer.
*
* @param {Int8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {Int8Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Set the content of a 2 by 2 byte buffered matrix to the content of an identity matrix.
*
* @param {Int8Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
*
* @return {Int8Array} The buffer, updated with content of an identity matrix.
*/
...
/**
* Set the content of a 2 by 2 byte buffered matrix to the content of a 2 dimensional scale matrix.
*
* @param {Int8Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
* @param {number} x - Scale factor of the x axis.
* @param {number} y - Scale factor of the y axis.
*
* @return {Int8Array} The buffer, updated with the content of a 2 dimensional scale matrix.
*/
...
/**
* Set the content of a 2 by 2 byte buffered matrix to a 2 dimensional rotation.
*
* @param {Int8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
* @param {number} x - Rotation for the x axis in radians.
* @param {number} y - Rotation for the y axis in radians.
*
* @return {Int8Array} The buffer, updated with the content of a 2 dimensional rotation.
*/
...
/**
* Set the content of a 2 by 2 byte buffered matrix to the content of a 1 dimensional translation matrix.
*
* @param {Int8Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
* @param {number} x - Translation to apply to the x axis.
*
* @return {Int8Array} The buffer, updated with the content of a 1 dimensional translation matrix.
*/
...
/**
* Compute and return the determinant of a 2 by 2 byte buffered matrix.
*
* @param {Int8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
*
* @return {number} The determinant of the given 2 by 2 byte buffered matrix.
*/
...
/**
* Invert a 2 by 2 byte buffered matrix and write the result into another buffer.
*
* @param {Int8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Int8Array} resultBuffer - Buffer to write.
...
/**
* Extract a translation from a 2 by 2 byte buffered matrix
*
* @param {Int8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Int8Array} resultBuffer - Buffer to write.
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Int8Array} The result buffer updated with the content of the translation vector extracted from the given matrix.
*/
...
/**
* Extract a scale from a 2 by 2 byte buffered matrix
*
* @param {Int8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Int8Array} resultBuffer - Buffer to write.
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Int8Array} The result buffer updated with the content of the 2 dimensional scale vector extracted from the given matrix.
*/
...
/**
* Extract a 2D rotation from a 2 by 2 byte buffered matrix
*
* @param {Int8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
*
