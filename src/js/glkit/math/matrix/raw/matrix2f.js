...
* @param {number} y - Scale factor of the y axis.
*
* @return {Float32Array} The buffer, updated with the content of a 2 dimensional scale matrix.
*/
...
* @param {number} y - Rotation for the y axis in radians.
*
* @return {Float32Array} The buffer, updated with the content of a 2 dimensional rotation.
*/
...
* @param {number} x - Translation to apply to the x axis.
*
* @return {Float32Array} The buffer, updated with the content of a 1 dimensional translation matrix.
*/
...
*
* @return {number} The determinant of the given 2 by 2 float buffered matrix.
*/
...
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Float32Array} The result buffer updated with the content of the 2 dimensional scale vector extracted from the given matrix.
*/
