...
* @param {number} z - Scale factor of the z axis.
*
* @return {Float64Array} The buffer, updated with the content of a 3 dimensional scale matrix.
*/
...
* @param {number} z - Rotation for the z axis in radians.
*
* @return {Float64Array} The buffer, updated with the content of a 3 dimensional rotation.
*/
...
* @param {number} y - Translation to apply to the y axis.
*
* @return {Float64Array} The buffer, updated with the content of a 2 dimensional translation matrix.
*/
...
*
* @return {number} The determinant of the given 3 by 3 double buffered matrix.
*/
...
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Float64Array} The result buffer updated with the content of the 3 dimensional scale vector extracted from the given matrix.
*/
