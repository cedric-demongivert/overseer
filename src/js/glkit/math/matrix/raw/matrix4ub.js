/**
* Transform a 4 by 4 unsigned byte buffered matrix into a string.
*
* @param {Uint8Array} matrixBuffer - The buffer that contains the matrix to transform.
...
export function toString (
  ...
  if (matrixBuffer == null) {
    return 'matrix 4 by 4 unsigned byte null'
  } else {
    return [
      `matrix 4 by 4 unsigned byte `,
      '[',
...
/**
* Fill a 4 by 4 unsigned byte buffered matrix with a given value.
*
* @param {Uint8Array} matrixBuffer - Buffer that contains the matrix to fill.
...
*
* @return {Uint8Array} The buffer with the updated matrix.
*/
...
/**
* Compare two 4 by 4 unsigned byte buffered matrix and return true if they are both equals.
*
* @param {Uint8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the buffer that contains the left operand matrix.
* @param {Uint8Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Set the content of a 4 by 4 unsigned byte buffered matrix.
*
* @param {Uint8Array} buffer - Buffer to mutate.
...
*
* @return {Uint8Array} The buffer, updated with the given data.
*/
export function set (
  buffer,
  bufferOffset,
...
/**
* Copy the content of a 4 by 4 unsigned byte buffered matrix into another.
*
* @param {Uint8Array} sourceBuffer - Buffer to read.
* @param {number} sourceBufferOffset - Offset to apply when we read the source buffer.
* @param {Uint8Array} destinationBuffer - Buffer to write.
* @param {number} destinationBufferOffset - Offset to apply when we write into the destination buffer.
*
* @return {Uint8Array} The destination buffer, updated with the source data.
*/
...
/**
* Transpose a 4 by 4 unsigned byte buffered matrix and put the result into another buffer.
*
* @param {Uint8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the source buffer.
* @param {Uint8Array} resultBuffer - Buffer to write.
* @param {number} resultBufferOffset - Offset to apply when we write into the destination buffer.
*
* @return {Uint8Array} The destination buffer, updated with the transposed matrix readed from the source buffer.
*/
...
/**
* Multiply 4 by 4 unsigned byte buffered matrix with another and put the result into a third buffer.
*
* @param {Uint8Array} leftBuffer - Buffer that contains the left operand matrix.
...
* @param {number} resultBufferOffset - Offset to apply when we write into the destination buffer.
*
* @return {Uint8Array} The destination buffer, updated with the result of the operation.
*/
...
/**
* Multiply a 4 by 4 unsigned byte buffered matrix with another static matrix, the buffered matrix will be used as a left operand.
*
* @param {Uint8Array} matrixBuffer - Buffer that contains the left operand matrix.
...
/**
* Multiply 4 by 4 unsigned byte buffered matrix with a 4 unsigned byte buffered vector and put the result into a third buffer.
*
* @param {Uint8Array} matrixBuffer - Buffer that contains the left operand matrix.
* @param {number} matrixBufferOffset - Offset to apply when we read the first buffer.
* @param {Uint8Array} vectorBuffer - Buffer that contains the right operand vector.
...
/**
* Multiply a 4 by 4 unsigned byte buffered matrix with a scalar and put the result into another buffer.
*
* @param {Uint8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
...
/**
* Negate a 4 by 4 unsigned byte buffered matrix and put the result into another buffer.
*
* @param {Uint8Array} matrixBuffer - Buffer that contains the matrix.
...
/**
* Divide a 4 by 4 unsigned byte buffered matrix with a scalar and put the result into another buffer.
*
* @param {Uint8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {number} scalar - Scalar to use as right operand.
...
/**
* Apply a 4 dimensional scale to a 4 by 4 unsigned byte buffered matrix and put the result into another buffer.
*
* @param {Uint8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Apply a 3 dimensional rotation to a 4 by 4 unsigned byte buffered matrix and put the result into another buffer.
*
* @param {Uint8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Apply a 3 dimensional translation to a 4 by 4 unsigned byte buffered matrix and put the result into another buffer.
*
* @param {Uint8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Add a 4 by 4 unsigned byte buffered matrix to another one and put the result into a third buffer.
*
* @param {Uint8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {Uint8Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Subtract a 4 by 4 unsigned byte buffered matrix to one and put the result into a third buffer.
*
* @param {Uint8Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {Uint8Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Set the content of a 4 by 4 unsigned byte buffered matrix to the content of an identity matrix.
*
* @param {Uint8Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
*
* @return {Uint8Array} The buffer, updated with content of an identity matrix.
*/
...
/**
* Set the content of a 4 by 4 unsigned byte buffered matrix to the content of a 4 dimensional scale matrix.
*
* @param {Uint8Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
* @param {number} x - Scale factor of the x axis.
...
* @param {number} w - Scale factor of the w axis.
*
* @return {Uint8Array} The buffer, updated with the content of a 4 dimensional scale matrix.
*/
...
/**
* Set the content of a 4 by 4 unsigned byte buffered matrix to a 3 dimensional rotation.
*
* @param {Uint8Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
* @param {number} x - Rotation for the x axis in radians.
...
* @param {number} z - Rotation for the z axis in radians.
*
* @return {Uint8Array} The buffer, updated with the content of a 3 dimensional rotation.
*/
...
/**
* Set the content of a 4 by 4 unsigned byte buffered matrix to the content of a 3 dimensional translation matrix.
*
* @param {Uint8Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
* @param {number} x - Translation to apply to the x axis.
...
* @param {number} z - Translation to apply to the z axis.
*
* @return {Uint8Array} The buffer, updated with the content of a 3 dimensional translation matrix.
*/
...
/**
* Compute and return the determinant of a 4 by 4 unsigned byte buffered matrix.
*
* @param {Uint8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
*
* @return {number} The determinant of the given 4 by 4 unsigned byte buffered matrix.
*/
...
/**
* Invert a 4 by 4 unsigned byte buffered matrix and write the result into another buffer.
*
* @param {Uint8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Uint8Array} resultBuffer - Buffer to write.
...
*
* @return {Uint8Array} The result buffer updated with the result of this operation.
*/
...
/**
* Extract a translation from a 4 by 4 unsigned byte buffered matrix
*
* @param {Uint8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Uint8Array} resultBuffer - Buffer to write.
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Uint8Array} The result buffer updated with the content of the translation vector extracted from the given matrix.
*/
...
/**
* Extract a scale from a 4 by 4 unsigned byte buffered matrix
*
* @param {Uint8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Uint8Array} resultBuffer - Buffer to write.
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Uint8Array} The result buffer updated with the content of the 4 dimensional scale vector extracted from the given matrix.
*/
...
/**
* Extract a 2D rotation from a 4 by 4 unsigned byte buffered matrix
*
* @param {Uint8Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
*
