/**
* Transform a 4 by 4 unsigned integer buffered matrix into a string.
*
* @param {Uint32Array} matrixBuffer - The buffer that contains the matrix to transform.
...
export function toString (
  ...
  if (matrixBuffer == null) {
    return 'matrix 4 by 4 unsigned integer null'
  } else {
    return [
      `matrix 4 by 4 unsigned integer `,
      '[',
...
/**
* Fill a 4 by 4 unsigned integer buffered matrix with a given value.
*
* @param {Uint32Array} matrixBuffer - Buffer that contains the matrix to fill.
...
*
* @return {Uint32Array} The buffer with the updated matrix.
*/
...
/**
* Compare two 4 by 4 unsigned integer buffered matrix and return true if they are both equals.
*
* @param {Uint32Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the buffer that contains the left operand matrix.
* @param {Uint32Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Set the content of a 4 by 4 unsigned integer buffered matrix.
*
* @param {Uint32Array} buffer - Buffer to mutate.
...
*
* @return {Uint32Array} The buffer, updated with the given data.
*/
export function set (
  buffer,
  bufferOffset,
...
/**
* Copy the content of a 4 by 4 unsigned integer buffered matrix into another.
*
* @param {Uint32Array} sourceBuffer - Buffer to read.
* @param {number} sourceBufferOffset - Offset to apply when we read the source buffer.
* @param {Uint32Array} destinationBuffer - Buffer to write.
* @param {number} destinationBufferOffset - Offset to apply when we write into the destination buffer.
*
* @return {Uint32Array} The destination buffer, updated with the source data.
*/
...
/**
* Transpose a 4 by 4 unsigned integer buffered matrix and put the result into another buffer.
*
* @param {Uint32Array} matrixBuffer - Buffer to read.
...
*
* @return {Uint32Array} The destination buffer, updated with the transposed matrix readed from the source buffer.
*/
...
/**
* Multiply 4 by 4 unsigned integer buffered matrix with another and put the result into a third buffer.
*
* @param {Uint32Array} leftBuffer - Buffer that contains the left operand matrix.
...
* @param {number} resultBufferOffset - Offset to apply when we write into the destination buffer.
*
* @return {Uint32Array} The destination buffer, updated with the result of the operation.
*/
...
/**
* Multiply a 4 by 4 unsigned integer buffered matrix with another static matrix, the buffered matrix will be used as a left operand.
*
* @param {Uint32Array} matrixBuffer - Buffer that contains the left operand matrix.
...
/**
* Multiply 4 by 4 unsigned integer buffered matrix with a 4 unsigned integer buffered vector and put the result into a third buffer.
*
* @param {Uint32Array} matrixBuffer - Buffer that contains the left operand matrix.
* @param {number} matrixBufferOffset - Offset to apply when we read the first buffer.
* @param {Uint32Array} vectorBuffer - Buffer that contains the right operand vector.
...
/**
* Multiply a 4 by 4 unsigned integer buffered matrix with a scalar and put the result into another buffer.
*
* @param {Uint32Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
...
/**
* Negate a 4 by 4 unsigned integer buffered matrix and put the result into another buffer.
*
* @param {Uint32Array} matrixBuffer - Buffer that contains the matrix.
...
/**
* Divide a 4 by 4 unsigned integer buffered matrix with a scalar and put the result into another buffer.
*
* @param {Uint32Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {number} scalar - Scalar to use as right operand.
...
/**
* Apply a 4 dimensional scale to a 4 by 4 unsigned integer buffered matrix and put the result into another buffer.
*
* @param {Uint32Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Apply a 3 dimensional rotation to a 4 by 4 unsigned integer buffered matrix and put the result into another buffer.
*
* @param {Uint32Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Apply a 3 dimensional translation to a 4 by 4 unsigned integer buffered matrix and put the result into another buffer.
*
* @param {Uint32Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
/**
* Add a 4 by 4 unsigned integer buffered matrix to another one and put the result into a third buffer.
*
* @param {Uint32Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {Uint32Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Subtract a 4 by 4 unsigned integer buffered matrix to one and put the result into a third buffer.
*
* @param {Uint32Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the first buffer.
* @param {Uint32Array} rightBuffer - Buffer that contains the right operand matrix.
...
/**
* Set the content of a 4 by 4 unsigned integer buffered matrix to the content of an identity matrix.
*
* @param {Uint32Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
*
* @return {Uint32Array} The buffer, updated with content of an identity matrix.
*/
...
/**
* Set the content of a 4 by 4 unsigned integer buffered matrix to the content of a 4 dimensional scale matrix.
*
* @param {Uint32Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
* @param {number} x - Scale factor of the x axis.
...
* @param {number} w - Scale factor of the w axis.
*
* @return {Uint32Array} The buffer, updated with the content of a 4 dimensional scale matrix.
*/
...
/**
* Set the content of a 4 by 4 unsigned integer buffered matrix to a 3 dimensional rotation.
*
* @param {Uint32Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
* @param {number} x - Rotation for the x axis in radians.
...
* @param {number} z - Rotation for the z axis in radians.
*
* @return {Uint32Array} The buffer, updated with the content of a 3 dimensional rotation.
*/
...
/**
* Set the content of a 4 by 4 unsigned integer buffered matrix to the content of a 3 dimensional translation matrix.
*
* @param {Uint32Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
* @param {number} x - Translation to apply to the x axis.
...
* @param {number} z - Translation to apply to the z axis.
*
* @return {Uint32Array} The buffer, updated with the content of a 3 dimensional translation matrix.
*/
...
/**
* Compute and return the determinant of a 4 by 4 unsigned integer buffered matrix.
*
* @param {Uint32Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
*
* @return {number} The determinant of the given 4 by 4 unsigned integer buffered matrix.
*/
...
/**
* Invert a 4 by 4 unsigned integer buffered matrix and write the result into another buffer.
*
* @param {Uint32Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Uint32Array} resultBuffer - Buffer to write.
...
/**
* Extract a translation from a 4 by 4 unsigned integer buffered matrix
*
* @param {Uint32Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Uint32Array} resultBuffer - Buffer to write.
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Uint32Array} The result buffer updated with the content of the translation vector extracted from the given matrix.
*/
...
/**
* Extract a scale from a 4 by 4 unsigned integer buffered matrix
*
* @param {Uint32Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Uint32Array} resultBuffer - Buffer to write.
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Uint32Array} The result buffer updated with the content of the 4 dimensional scale vector extracted from the given matrix.
*/
...
/**
* Extract a 2D rotation from a 4 by 4 unsigned integer buffered matrix
*
* @param {Uint32Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
*
