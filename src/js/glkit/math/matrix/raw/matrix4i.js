...
*
* @param {Int32Array} matrixBuffer - The buffer that contains the matrix to transform.
...
*
* @param {Int32Array} matrixBuffer - Buffer that contains the matrix to fill.
...
*
* @return {Int32Array} The buffer with the updated matrix.
*/
...
*
* @param {Int32Array} leftBuffer - Buffer that contains the left operand matrix.
* @param {number} leftBufferOffset - Offset to apply when we read the buffer that contains the left operand matrix.
* @param {Int32Array} rightBuffer - Buffer that contains the right operand matrix.
...
*
* @param {Int32Array} buffer - Buffer to mutate.
...
*
* @return {Int32Array} The buffer, updated with the given data.
*/
export function set (
  buffer,
  bufferOffset,
...
*
* @param {Int32Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the source buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
* @param {number} resultBufferOffset - Offset to apply when we write into the destination buffer.
*
* @return {Int32Array} The destination buffer, updated with the transposed matrix readed from the source buffer.
*/
...
* @param {number} resultBufferOffset - Offset to apply when we write into the destination buffer.
*
* @return {Int32Array} The destination buffer, updated with the result of the operation.
*/
...
*
* @param {Int32Array} matrixBuffer - Buffer that contains the left operand matrix.
...
* @param {Int32Array} matrixBuffer - Buffer that contains the left operand matrix.
* @param {number} matrixBufferOffset - Offset to apply when we read the first buffer.
* @param {Int32Array} vectorBuffer - Buffer that contains the right operand vector.
...
*
* @param {Int32Array} matrixBuffer - Buffer that contains the matrix.
...
*
* @param {Int32Array} matrixBuffer - Buffer that contains the matrix to transform.
* @param {number} matrixBufferOffset - Offset to apply when we read the matrix buffer.
...
*
* @param {Int32Array} matrixBuffer - Buffer to write.
* @param {number} matrixBufferOffset - Offset to apply when we write into the buffer.
*
* @return {Int32Array} The buffer, updated with content of an identity matrix.
*/
...
* @param {number} w - Scale factor of the w axis.
*
* @return {Int32Array} The buffer, updated with the content of a 4 dimensional scale matrix.
*/
...
* @param {number} z - Rotation for the z axis in radians.
*
* @return {Int32Array} The buffer, updated with the content of a 3 dimensional rotation.
*/
...
* @param {number} z - Translation to apply to the z axis.
*
* @return {Int32Array} The buffer, updated with the content of a 3 dimensional translation matrix.
*/
...
*
* @return {number} The determinant of the given 4 by 4 integer buffered matrix.
*/
...
/**
* Invert a 4 by 4 integer buffered matrix and write the result into another buffer.
*
* @param {Int32Array} matrixBuffer - Buffer to read.
* @param {number} matrixBufferOffset - Offset to apply when we read the buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
...
*
* @return {Int32Array} The result buffer updated with the result of this operation.
*/
...
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Int32Array} The result buffer updated with the content of the translation vector extracted from the given matrix.
*/
...
* @param {number} resultBufferOffset - Offset to apply when we write into the result buffer.
*
* @return {Int32Array} The result buffer updated with the content of the 4 dimensional scale vector extracted from the given matrix.
*/
