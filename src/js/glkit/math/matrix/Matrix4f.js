import matrix4f from './raw/matrix4f'

export class Matrix4f {
  /**
  * Create a new 4 by 4 float matrix with initial content.
  *
  * @param {...number} content - Content of new 4 by 4 float matrix in row-major order.
  *
  * @return {Matrix4f} A new 4 by 4 float matrix with the given initial content.
  */
  static create (
    a00, a10, a20, a30,
    a01, a11, a21, a31,
  ...
  *
  * @return {Matrix4f} A new 4 by 4 float matrix that wrap the given buffer.
  */
  static wrap (buffer) {
  ...
  *
  * @param {Matrix4f} toClone - A 4 by 4 float matrix instance to clone.
  *
  * @return {Matrix4f} A new 4 by 4 float matrix that wrap the given buffer.
  */
  ...
  *
  * @param {Float32Array} [buffer = new Float32Array(16)] - A buffer to wrap.
  */
  ...
  */
  get determinant () {
    return matrix4f.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix4f} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 4 by 4 float matrix in row-major order.
  *
  * @return {Matrix4f} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix4f} toCopy - Matrix instance to copy.
  *
  * @return {Matrix4f} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix4f.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix4f.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix4f} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4f} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix4f.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix4f.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix4f.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix4f} left - Left operand matrix.
  * @param {Matrix4f} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4f} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix4f.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix4f.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix4f.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  *
  * @param {Vector4f} left - Left operand vector.
  * @param {Vector4f} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4f} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix4f.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix4f.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix4f.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix4f.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix4f.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix4f.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y, z, w) {
    matrix4f.toScale(this._buffer, 0, x, y, z, w)
    return this
  }
  ...
  */
  toRotation (x, y, z) {
    matrix4f.toRotation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toTranslation (x, y, z) {
    matrix4f.toTranslation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  *
  * @param {Vector4f} result - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4f} The updated instance of this matrix for chaining purpose.
  */
  extractScale (result) {
    matrix4f.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extractTranslation (result) {
    matrix4f.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix4f.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix4f} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix4f.toString(this._buffer, 0)
  }
}