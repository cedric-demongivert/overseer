import matrix3us from './raw/matrix3us'

export class Matrix3us {
  /**
  * Create a new 3 by 3 unsigned short matrix with initial content.
  *
  * @param {...number} content - Content of new 3 by 3 unsigned short matrix in row-major order.
  *
  * @return {Matrix3us} A new 3 by 3 unsigned short matrix with the given initial content.
  */
  static create (
    a00, a10, a20,
    a01, a11, a21,
    ...
    const result = new Matrix3us().set(
      a00, a10, a20,
      a01, a11, a21,
      a02, a12, a22
    )
  ...
  /**
  * Wrap a Uint16Array as a 3 by 3 unsigned short matrix.
  *
  * @param {Uint16Array} buffer - A buffer to wrap.
  *
  * @return {Matrix3us} A new 3 by 3 unsigned short matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix3us(buffer)
  }

  /**
  * Clone a Uint16Array as a 3 by 3 unsigned short matrix instance and return the result.
  *
  * @param {Matrix3us} toClone - A 3 by 3 unsigned short matrix instance to clone.
  *
  * @return {Matrix3us} A new 3 by 3 unsigned short matrix that wrap the given buffer.
  */
  static clone (toClone) {
    const result = new Matrix3us()
  ...
  /**
  * Wrap a Uint16Array as a 3 by 3 matrix.
  *
  * @param {Uint16Array} [buffer = new Uint16Array(9)] - A buffer to wrap.
  */
  constructor (buffer = new Uint16Array(9)) {
    this._buffer = buffer
  }
  ...
  */
  get determinant () {
    return matrix3us.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix3us} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 3 by 3 unsigned short matrix in row-major order.
  *
  * @return {Matrix3us} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix3us} toCopy - Matrix instance to copy.
  *
  * @return {Matrix3us} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix3us.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix3us.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix3us} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix3us} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix3us.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix3us.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix3us.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix3us} left - Left operand matrix.
  * @param {Matrix3us} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix3us} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix3us.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix3us.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10, a20,
      a01, a11, a21,
      a02, a12, a22
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix3us.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10, a20,
      a01, a11, a21,
      a02, a12, a22
  ...
  * @param {Vector3us} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix3us} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix3us.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix3us.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix3us.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix3us.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix3us.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix3us.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y, z) {
    matrix3us.toScale(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toRotation (x, y, z) {
    matrix3us.toRotation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toTranslation (x, y) {
    matrix3us.toTranslation(this._buffer, 0, x, y)
    return this
  }
  ...
  */
  extractScale (result) {
    matrix3us.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extractTranslation (result) {
    matrix3us.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix3us.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix3us} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix3us.toString(this._buffer, 0)
  }
}