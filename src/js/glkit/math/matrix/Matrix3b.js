import matrix3b from './raw/matrix3b'

export class Matrix3b {
  /**
  * Create a new 3 by 3 byte matrix with initial content.
  *
  * @param {...number} content - Content of new 3 by 3 byte matrix in row-major order.
  *
  * @return {Matrix3b} A new 3 by 3 byte matrix with the given initial content.
  */
  static create (
    a00, a10, a20,
    a01, a11, a21,
  ...
  /**
  * Wrap a Int8Array as a 3 by 3 byte matrix.
  *
  * @param {Int8Array} buffer - A buffer to wrap.
  *
  * @return {Matrix3b} A new 3 by 3 byte matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix3b(buffer)
  }

  /**
  * Clone a Int8Array as a 3 by 3 byte matrix instance and return the result.
  *
  * @param {Matrix3b} toClone - A 3 by 3 byte matrix instance to clone.
  *
  * @return {Matrix3b} A new 3 by 3 byte matrix that wrap the given buffer.
  */
  static clone (toClone) {
    const result = new Matrix3b()
  ...
  /**
  * Wrap a Int8Array as a 3 by 3 matrix.
  *
  * @param {Int8Array} [buffer = new Int8Array(9)] - A buffer to wrap.
  */
  constructor (buffer = new Int8Array(9)) {
    this._buffer = buffer
  }
  ...
  */
  get determinant () {
    return matrix3b.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix3b} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 3 by 3 byte matrix in row-major order.
  *
  * @return {Matrix3b} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix3b} toCopy - Matrix instance to copy.
  *
  * @return {Matrix3b} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix3b.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix3b.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix3b} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix3b} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix3b.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix3b.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix3b.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix3b} left - Left operand matrix.
  * @param {Matrix3b} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix3b} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix3b.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix3b.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10, a20,
      a01, a11, a21,
      a02, a12, a22
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix3b.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10, a20,
      a01, a11, a21,
      a02, a12, a22
  ...
  * @param {Vector3b} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix3b} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix3b.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix3b.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix3b.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix3b.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix3b.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix3b.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y, z) {
    matrix3b.toScale(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toRotation (x, y, z) {
    matrix3b.toRotation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toTranslation (x, y) {
    matrix3b.toTranslation(this._buffer, 0, x, y)
    return this
  }
  ...
  */
  extractScale (result) {
    matrix3b.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Vector2b} result - Vector to use for writing the result of this operation.
  *
  * @return {Matrix3b} The updated instance of this matrix for chaining purpose.
  */
  extractTranslation (result) {
    matrix3b.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix3b.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix3b} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix3b.toString(this._buffer, 0)
  }
}