import matrix4b from './raw/matrix4b'

export class Matrix4b {
  /**
  * Create a new 4 by 4 byte matrix with initial content.
  *
  * @param {...number} content - Content of new 4 by 4 byte matrix in row-major order.
  *
  * @return {Matrix4b} A new 4 by 4 byte matrix with the given initial content.
  */
  static create (
    a00, a10, a20, a30,
    a01, a11, a21, a31,
  ...
  /**
  * Wrap a Int8Array as a 4 by 4 byte matrix.
  *
  * @param {Int8Array} buffer - A buffer to wrap.
  *
  * @return {Matrix4b} A new 4 by 4 byte matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix4b(buffer)
  }

  /**
  * Clone a Int8Array as a 4 by 4 byte matrix instance and return the result.
  *
  * @param {Matrix4b} toClone - A 4 by 4 byte matrix instance to clone.
  *
  * @return {Matrix4b} A new 4 by 4 byte matrix that wrap the given buffer.
  */
  static clone (toClone) {
    const result = new Matrix4b()
  ...
  /**
  * Wrap a Int8Array as a 4 by 4 matrix.
  *
  * @param {Int8Array} [buffer = new Int8Array(16)] - A buffer to wrap.
  */
  constructor (buffer = new Int8Array(16)) {
    this._buffer = buffer
  }
  ...
  */
  ...
  /**
  * @return {Int8Array} The underlying buffer of this matrix.
  */
  get buffer () {
    return this._buffer
  }
  ...
  */
  get determinant () {
    return matrix4b.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix4b} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 4 by 4 byte matrix in row-major order.
  *
  * @return {Matrix4b} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix4b} toCopy - Matrix instance to copy.
  *
  * @return {Matrix4b} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix4b.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix4b.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix4b} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4b} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix4b.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix4b.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix4b.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix4b} left - Left operand matrix.
  * @param {Matrix4b} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4b} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix4b.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix4b.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix4b.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  *
  * @param {Vector4b} left - Left operand vector.
  * @param {Vector4b} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4b} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix4b.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix4b.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix4b.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix4b.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix4b.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix4b.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y, z, w) {
    matrix4b.toScale(this._buffer, 0, x, y, z, w)
    return this
  }
  ...
  */
  toRotation (x, y, z) {
    matrix4b.toRotation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toTranslation (x, y, z) {
    matrix4b.toTranslation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  *
  * @param {Vector4b} result - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4b} The updated instance of this matrix for chaining purpose.
  */
  extractScale (result) {
    matrix4b.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Vector3b} result - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4b} The updated instance of this matrix for chaining purpose.
  */
  extractTranslation (result) {
    matrix4b.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix4b.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix4b} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix4b.toString(this._buffer, 0)
  }
}