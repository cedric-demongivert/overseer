import matrix4d from './raw/matrix4d'

export class Matrix4d {
  /**
  * Create a new 4 by 4 double matrix with initial content.
  *
  * @param {...number} content - Content of new 4 by 4 double matrix in row-major order.
  *
  * @return {Matrix4d} A new 4 by 4 double matrix with the given initial content.
  */
  static create (
    a00, a10, a20, a30,
    a01, a11, a21, a31,
  ...
  *
  * @return {Matrix4d} A new 4 by 4 double matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix4d(buffer)
  }

  /**
  * Clone a Float64Array as a 4 by 4 double matrix instance and return the result.
  *
  * @param {Matrix4d} toClone - A 4 by 4 double matrix instance to clone.
  *
  * @return {Matrix4d} A new 4 by 4 double matrix that wrap the given buffer.
  */
  ...
  *
  * @param {Float64Array} [buffer = new Float64Array(16)] - A buffer to wrap.
  */
  ...
  */
  get determinant () {
    return matrix4d.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix4d} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 4 by 4 double matrix in row-major order.
  *
  * @return {Matrix4d} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix4d} toCopy - Matrix instance to copy.
  *
  * @return {Matrix4d} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix4d.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix4d.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix4d} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4d} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix4d.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix4d.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix4d.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix4d} left - Left operand matrix.
  * @param {Matrix4d} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix4d} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix4d.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix4d.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix4d.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10, a20, a30,
      a01, a11, a21, a31,
      a02, a12, a22, a32,
  ...
  *
  * @param {Vector4d} left - Left operand vector.
  * @param {Vector4d} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4d} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix4d.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix4d.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix4d.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix4d.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix4d.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix4d.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y, z, w) {
    matrix4d.toScale(this._buffer, 0, x, y, z, w)
    return this
  }
  ...
  */
  toRotation (x, y, z) {
    matrix4d.toRotation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toTranslation (x, y, z) {
    matrix4d.toTranslation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  *
  * @param {Vector4d} result - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4d} The updated instance of this matrix for chaining purpose.
  */
  extractScale (result) {
    matrix4d.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Vector3d} result - Vector to use for writing the result of this operation.
  *
  * @return {Matrix4d} The updated instance of this matrix for chaining purpose.
  */
  extractTranslation (result) {
    matrix4d.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix4d.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix4d} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix4d.toString(this._buffer, 0)
  }
}