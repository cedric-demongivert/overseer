import matrix2b from './raw/matrix2b'

export class Matrix2b {
  /**
  * Create a new 2 by 2 byte matrix with initial content.
  *
  * @param {...number} content - Content of new 2 by 2 byte matrix in row-major order.
  *
  * @return {Matrix2b} A new 2 by 2 byte matrix with the given initial content.
  */
  static create (
    a00, a10,
    a01, a11
  ) {
    const result = new Matrix2b().set(
      a00, a10,
      a01, a11
    )
  }
  ...
  /**
  * Wrap a Int8Array as a 2 by 2 byte matrix.
  *
  * @param {Int8Array} buffer - A buffer to wrap.
  *
  * @return {Matrix2b} A new 2 by 2 byte matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix2b(buffer)
  }

  /**
  * Clone a Int8Array as a 2 by 2 byte matrix instance and return the result.
  *
  * @param {Matrix2b} toClone - A 2 by 2 byte matrix instance to clone.
  *
  * @return {Matrix2b} A new 2 by 2 byte matrix that wrap the given buffer.
  */
  static clone (toClone) {
    const result = new Matrix2b()
  ...
  /**
  * Wrap a Int8Array as a 2 by 2 matrix.
  *
  * @param {Int8Array} [buffer = new Int8Array(4)] - A buffer to wrap.
  */
  constructor (buffer = new Int8Array(4)) {
    this._buffer = buffer
  }
  ...
  */
  get determinant () {
    return matrix2b.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix2b} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 2 by 2 byte matrix in row-major order.
  *
  * @return {Matrix2b} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix2b} toCopy - Matrix instance to copy.
  *
  * @return {Matrix2b} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix2b.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix2b.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix2b} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix2b} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix2b.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix2b.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix2b.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix2b} left - Left operand matrix.
  * @param {Matrix2b} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix2b} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix2b.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix2b.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10,
      a01, a11
      result.buffer, 0
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix2b.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10,
      a01, a11
      result.buffer, 0
  ...
  * @param {Vector2b} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix2b} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix2b.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix2b.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix2b.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix2b.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix2b.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix2b.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y) {
    matrix2b.toScale(this._buffer, 0, x, y)
    return this
  }
  ...
  */
  toRotation (x, y) {
    matrix2b.toRotation(this._buffer, 0, x, y)
    return this
  }
  ...
  */
  toTranslation (x) {
    matrix2b.toTranslation(this._buffer, 0, x)
    return this
  }
  ...
  */
  extractScale (result) {
    matrix2b.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extractTranslation (result) {
    matrix2b.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix2b.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix2b} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix2b.toString(this._buffer, 0)
  }
}