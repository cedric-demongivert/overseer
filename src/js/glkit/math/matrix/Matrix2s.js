import matrix2s from './raw/matrix2s'

export class Matrix2s {
  /**
  * Create a new 2 by 2 short matrix with initial content.
  *
  * @param {...number} content - Content of new 2 by 2 short matrix in row-major order.
  *
  * @return {Matrix2s} A new 2 by 2 short matrix with the given initial content.
  */
  static create (
    a00, a10,
    a01, a11
  ) {
    const result = new Matrix2s().set(
      a00, a10,
      a01, a11
    )
  }
  ...
  /**
  * Wrap a Int16Array as a 2 by 2 short matrix.
  *
  * @param {Int16Array} buffer - A buffer to wrap.
  *
  * @return {Matrix2s} A new 2 by 2 short matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix2s(buffer)
  }

  /**
  * Clone a Int16Array as a 2 by 2 short matrix instance and return the result.
  *
  * @param {Matrix2s} toClone - A 2 by 2 short matrix instance to clone.
  *
  * @return {Matrix2s} A new 2 by 2 short matrix that wrap the given buffer.
  */
  static clone (toClone) {
    const result = new Matrix2s()
  ...
  /**
  * Wrap a Int16Array as a 2 by 2 matrix.
  *
  ...
  */
  get determinant () {
    return matrix2s.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix2s} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 2 by 2 short matrix in row-major order.
  *
  * @return {Matrix2s} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix2s} toCopy - Matrix instance to copy.
  *
  * @return {Matrix2s} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix2s.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix2s.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix2s} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix2s} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix2s.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix2s.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix2s.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix2s} left - Left operand matrix.
  * @param {Matrix2s} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix2s} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix2s.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix2s.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10,
      a01, a11
      result.buffer, 0
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix2s.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10,
      a01, a11
      result.buffer, 0
  ...
  * @param {Vector2s} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix2s} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix2s.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix2s.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix2s.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix2s.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix2s.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix2s.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y) {
    matrix2s.toScale(this._buffer, 0, x, y)
    return this
  }
  ...
  */
  toRotation (x, y) {
    matrix2s.toRotation(this._buffer, 0, x, y)
    return this
  }
  ...
  */
  toTranslation (x) {
    matrix2s.toTranslation(this._buffer, 0, x)
    return this
  }
  ...
  */
  extractScale (result) {
    matrix2s.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extractTranslation (result) {
    matrix2s.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix2s.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix2s} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix2s.toString(this._buffer, 0)
  }
}