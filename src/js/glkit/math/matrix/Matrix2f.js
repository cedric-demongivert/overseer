import matrix2f from './raw/matrix2f'

export class Matrix2f {
  /**
  * Create a new 2 by 2 float matrix with initial content.
  *
  * @param {...number} content - Content of new 2 by 2 float matrix in row-major order.
  *
  * @return {Matrix2f} A new 2 by 2 float matrix with the given initial content.
  */
  static create (
    a00, a10,
    a01, a11
  ) {
    const result = new Matrix2f().set(
      a00, a10,
      a01, a11
    )
  }
  ...
  *
  * @return {Matrix2f} A new 2 by 2 float matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix2f(buffer)
  }

  /**
  * Clone a Float32Array as a 2 by 2 float matrix instance and return the result.
  *
  * @param {Matrix2f} toClone - A 2 by 2 float matrix instance to clone.
  *
  * @return {Matrix2f} A new 2 by 2 float matrix that wrap the given buffer.
  */
  static clone (toClone) {
    const result = new Matrix2f()
  ...
  *
  * @param {Float32Array} [buffer = new Float32Array(4)] - A buffer to wrap.
  */
  ...
  */
  get determinant () {
    return matrix2f.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix2f} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 2 by 2 float matrix in row-major order.
  *
  * @return {Matrix2f} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix2f} toCopy - Matrix instance to copy.
  *
  * @return {Matrix2f} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix2f.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix2f.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix2f} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix2f} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix2f.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix2f.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix2f.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix2f} left - Left operand matrix.
  * @param {Matrix2f} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix2f} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix2f.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix2f.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10,
      a01, a11
      result.buffer, 0
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix2f.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10,
      a01, a11
      result.buffer, 0
  ...
  * @param {Vector2f} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix2f} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix2f.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix2f.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix2f.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix2f.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix2f.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix2f.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y) {
    matrix2f.toScale(this._buffer, 0, x, y)
    return this
  }
  ...
  */
  toRotation (x, y) {
    matrix2f.toRotation(this._buffer, 0, x, y)
    return this
  }
  ...
  */
  toTranslation (x) {
    matrix2f.toTranslation(this._buffer, 0, x)
    return this
  }
  ...
  */
  extractScale (result) {
    matrix2f.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extractTranslation (result) {
    matrix2f.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix2f.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix2f} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix2f.toString(this._buffer, 0)
  }
}