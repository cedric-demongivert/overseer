import matrix3i from './raw/matrix3i'

export class Matrix3i {
  /**
  * Create a new 3 by 3 integer matrix with initial content.
  *
  * @param {...number} content - Content of new 3 by 3 integer matrix in row-major order.
  *
  * @return {Matrix3i} A new 3 by 3 integer matrix with the given initial content.
  */
  static create (
    a00, a10, a20,
    a01, a11, a21,
  ...
  *
  * @return {Matrix3i} A new 3 by 3 integer matrix that wrap the given buffer.
  */
  static wrap (buffer) {
    return new Matrix3i(buffer)
  }

  /**
  * Clone a Int32Array as a 3 by 3 integer matrix instance and return the result.
  *
  * @param {Matrix3i} toClone - A 3 by 3 integer matrix instance to clone.
  *
  * @return {Matrix3i} A new 3 by 3 integer matrix that wrap the given buffer.
  */
  static clone (toClone) {
    const result = new Matrix3i()
  ...
  *
  * @param {Int32Array} [buffer = new Int32Array(9)] - A buffer to wrap.
  */
  ...
  */
  get determinant () {
    return matrix3i.determinant(this._buffer, 0)
  }
  ...
  *
  * @return {Matrix3i} The updated instance of this matrix for chaining purpose.
  */
  ...
  *
  * @param {...number} content - New content of this 3 by 3 integer matrix in row-major order.
  *
  * @return {Matrix3i} The updated instance of this matrix for chaining purpose.
  */
  set (
  ...
  *
  * @param {Matrix3i} toCopy - Matrix instance to copy.
  *
  * @return {Matrix3i} The updated instance of this matrix for chaining purpose.
  */
  copy (toCopy) {
    matrix3i.copy(toCopy.buffer, 0, this._buffer, 0)
    return this
  }
  ...
  */
  fill (value) {
    matrix3i.fill(this._buffer, 0, value)
    return this
  }
  ...
  *
  * @param {Matrix3i} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix3i} The updated instance of this matrix for chaining purpose.
  */
  transpose (result = this) {
    matrix3i.transpose(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  invert (result = this) {
    matrix3i.invert(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  negate (result = this) {
    matrix3i.negate(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  *
  * @param {Matrix3i} left - Left operand matrix.
  * @param {Matrix3i} [result = this] - Matrix to use for writing the result of this operation.
  *
  * @return {Matrix3i} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithMatrix (left, result = this) {
    matrix3i.multiplyWithMatrix(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithStaticMatrixAsRightOperand (
    ...
    matrix3i.multiplyWithStaticMatrixAsRightOperand(
      this._buffer, 0,
      a00, a10, a20,
      a01, a11, a21,
      a02, a12, a22
  ...
  */
  multiplyWithStaticMatrixAsLeftOperand (
    ...
    matrix3i.multiplyWithStaticMatrixAsLeftOperand(
      this._buffer, 0,
      a00, a10, a20,
      a01, a11, a21,
      a02, a12, a22
  ...
  *
  * @param {Vector3i} left - Left operand vector.
  * @param {Vector3i} [result = left] - Vector to use for writing the result of this operation.
  *
  * @return {Matrix3i} The updated instance of this matrix for chaining purpose.
  */
  multiplyWithVector (left, result = left) {
    matrix3i.multiplyWithVector(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  multiplyWithScalar (scalar, result = this) {
    matrix3i.multiplyWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  divideWithScalar (scalar, result = this) {
    matrix3i.divideWithScalar(this._buffer, 0, scalar, result.buffer, 0)
    return this
  }
  ...
  */
  add (left, result = this) {
    matrix3i.add(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  subtract (left, result = this) {
    matrix3i.subtract(this._buffer, 0, left.buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  toIdentity () {
    matrix3i.toIdentity(this._buffer, 0)
    return this
  }
  ...
  */
  toScale (x, y, z) {
    matrix3i.toScale(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toRotation (x, y, z) {
    matrix3i.toRotation(this._buffer, 0, x, y, z)
    return this
  }
  ...
  */
  toTranslation (x, y) {
    matrix3i.toTranslation(this._buffer, 0, x, y)
    return this
  }
  ...
  */
  extractScale (result) {
    matrix3i.extractScale(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extractTranslation (result) {
    matrix3i.extractTranslation(this._buffer, 0, result.buffer, 0)
    return this
  }
  ...
  */
  extract2DRotation () {
    return matrix3i.extract2DRotation(this._buffer, 0)
  }
  ...
  *
  * @param {Matrix3i} other - Matrix instance to use for comparison.
  ...
  */
  toString () {
    return matrix3i.toString(this._buffer, 0)
  }
}