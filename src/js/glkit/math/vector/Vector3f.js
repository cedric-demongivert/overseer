import vector3f from './raw/vector3f'
...
export class Vector3f {
  ...
  *
  * @return {Vector3f} The new vector instance.
  */
  static create (
    x,
    y,
  ...
  *
  * @param {Vector3f} vector - A 3 float vector to clone.
  *
  * @return {Vector3f} The cloned vector instance.
  */
  static clone (vector) {
  ...
  *
  * @param {Float32Array} [buffer = new Float32Array(3)] - A buffer to wrap.
  */
  ...
  */
  get squaredLength () {
    return vector3f.squaredLength(this._buffer, 0)
  }
  ...
  */
  get length () {
    return vector3f.length(this._buffer, 0)
  }
  ...
  * @param z - z component of the new vector
  *
  * @return {Vector3f} This vector instance for chaining purpose.
  */
  set (
    x,
    y,
    ...
    vector3f.set(this._buffer, 0, x, y, z)
    return this
  }
  ...
  * @param {Vector3f} [result = this] - The result vector.
  *
  * @return {Vector3f} This vector instance for chaining purpose.
  */
  ...
  */
  dot (left, tolerance = Number.EPSILON) {
    return vector3f.dot(this._buffer, 0, left.buffer, 0)
  }
  ...
  */
  equals (left, tolerance = Number.EPSILON) {
    return vector3f.equals(this._buffer, 0, left.buffer, 0, tolerance)
  }
  ...
  */
  toString () {
    return vector3f.toString(this._buffer, 0)
  }
}