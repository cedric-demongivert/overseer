/**
* Transform a 4 short buffered vector into a string.
*
...
/**
* Compute the addition of two 4 short buffered vectors and put the result into another buffer.
*
...
/**
* Compute the subtraction of two 4 short buffered vectors and put the result into another buffer.
*
* @param {Int16Array} leftBuffer - Buffer that contains the left operand.
* @param {number} leftBufferOffset - Offset to use when we read the buffer that contains the left operand.
* @param {Int16Array} rightBuffer - Buffer that contains the right operand.
...
/**
* Compute the dot product of two 4 short buffered vectors and return the result.
*
* @param {Int16Array} leftBuffer - Buffer that contains the left operand.
...
/**
* Return the squared length of a 4 short buffered vector.
*
* @param {Int16Array} vectorBuffer - Buffer that contains the vector to transform.
* @param {number} vectorBufferOffset - Offset to use when we read the buffer that contains the vector to transform.
*
...
/**
* Return the length of a 4 short buffered vector.
*
* @param {Int16Array} vectorBuffer - Buffer that contains the vector to transform.
* @param {number} vectorBufferOffset - Offset to use when we read the buffer that contains the vector to transform.
*
...
/**
* Set the content of a 4 short buffered vector.
*
...
/**
* Multiply a 4 short buffered vector with a scalar and put the result in another buffer.
*
...
/**
* Divide a 4 short buffered vector with a scalar and put the result in another buffer.
*
* @param {Int16Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
...
/**
* Negate a 4 short buffered vector and put the result in another buffer.
*
* @param {Int16Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int16Array} resultBuffer - Buffer to write.
...
/**
* Normalize a 4 short buffered vector and set the result into another buffer.
*
* @param {Int16Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int16Array} resultBuffer - Buffer to write.
...
/**
* Ceil each component of a 4 short buffered vector and put the result into another buffer.
*
* @param {Int16Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int16Array} resultBuffer - Buffer to write.
...
/**
* Floor each component of a 4 short buffered vector and put the result into another buffer.
*
* @param {Int16Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int16Array} resultBuffer - Buffer to write.
...
/**
* Round each component of a 4 short buffered vector and put the result into another buffer.
*
* @param {Int16Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int16Array} resultBuffer - Buffer to write.
...
/**
* Update each component of a 4 short buffered vector less than the given minimum, and put the result into another buffer.
*
* @param {Int16Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
...
/**
* Update each component of a 4 short buffered vector greather than the given maximum, and put the result into another buffer.
*
* @param {Int16Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
...
/**
* Clamp each component of 4 short buffered vector between two values, and put the result into another buffer.
*
* @param {Int16Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {number} minimum - Minimum value allowed.
...
/**
* Compute the a vector that is a mix of two 4 short buffered vectors and put the result into another buffer.
*
* @param {Int16Array} leftBuffer - Buffer that contains the left operand.
* @param {number} leftBufferOffset - Offset to use when we read the buffer that contains the left operand.
* @param {Int16Array} rightBuffer - Buffer that contains the right operand.
