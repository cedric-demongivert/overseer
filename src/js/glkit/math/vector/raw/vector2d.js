/**
* Transform a 2 double buffered vector into a string.
*
* @param {Float64Array} vectorBuffer - Buffer that contains the vector to transform.
...
*
* @param {Float64Array} leftBuffer - Buffer that contains the left operand vector.
* @param {boolean} leftBufferOffset - Offset to use when we read the buffer that contains the left operand vector.
* @param {Float64Array} rightBuffer - Buffer that contains the right operand vector.
...
/**
* Compute the addition of two 2 double buffered vectors and put the result into another buffer.
*
* @param {Float64Array} leftBuffer - Buffer that contains the left operand.
* @param {number} leftBufferOffset - Offset to use when we read the buffer that contains the left operand.
* @param {Float64Array} rightBuffer - Buffer that contains the right operand.
...
*
* @return {Float64Array} The updated result buffer.
*/
export function add (
  leftBuffer,
  leftBufferOffset,
...
*
* @param {Float64Array} vectorBuffer - Buffer to write.
...
*
* @return {Float64Array} The given buffer updated with the new values.
*/
export function set (
  vectorBuffer,
  vectorBufferOffset,
