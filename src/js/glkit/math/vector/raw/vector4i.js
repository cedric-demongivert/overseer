/**
* Transform a 4 integer buffered vector into a string.
*
* @param {Int32Array} vectorBuffer - Buffer that contains the vector to transform.
...
*
* @param {Int32Array} leftBuffer - Buffer that contains the left operand vector.
* @param {boolean} leftBufferOffset - Offset to use when we read the buffer that contains the left operand vector.
* @param {Int32Array} rightBuffer - Buffer that contains the right operand vector.
...
/**
* Compute the addition of two 4 integer buffered vectors and put the result into another buffer.
*
* @param {Int32Array} leftBuffer - Buffer that contains the left operand.
* @param {number} leftBufferOffset - Offset to use when we read the buffer that contains the left operand.
* @param {Int32Array} rightBuffer - Buffer that contains the right operand.
...
*
* @return {Int32Array} The updated result buffer.
*/
export function add (
  leftBuffer,
  leftBufferOffset,
...
*
* @param {Int32Array} vectorBuffer - Buffer to write.
...
*
* @return {Int32Array} The given buffer updated with the new values.
*/
export function set (
  vectorBuffer,
  vectorBufferOffset,
...
*
* @param {Int32Array} vectorBuffer - Buffer to read.
...
/**
* Normalize a 4 integer buffered vector and set the result into another buffer.
*
* @param {Int32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
...
/**
* Ceil each component of a 4 integer buffered vector and put the result into another buffer.
*
* @param {Int32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
...
/**
* Floor each component of a 4 integer buffered vector and put the result into another buffer.
*
* @param {Int32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
...
/**
* Round each component of a 4 integer buffered vector and put the result into another buffer.
*
* @param {Int32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
