/**
* Transform a 3 unsigned integer buffered vector into a string.
*
...
export function toString (vectorBuffer, vectorBufferOffset) {
  if (vectorBuffer == null) {
    return 'vector 3 unsigned integer null'
  } else {
...
/**
* Compute the addition of two 3 unsigned integer buffered vectors and put the result into another buffer.
*
...
/**
* Compute the subtraction of two 3 unsigned integer buffered vectors and put the result into another buffer.
*
* @param {Uint32Array} leftBuffer - Buffer that contains the left operand.
* @param {number} leftBufferOffset - Offset to use when we read the buffer that contains the left operand.
* @param {Uint32Array} rightBuffer - Buffer that contains the right operand.
...
/**
* Compute the dot product of two 3 unsigned integer buffered vectors and return the result.
*
* @param {Uint32Array} leftBuffer - Buffer that contains the left operand.
...
/**
* Return the squared length of a 3 unsigned integer buffered vector.
*
* @param {Uint32Array} vectorBuffer - Buffer that contains the vector to transform.
* @param {number} vectorBufferOffset - Offset to use when we read the buffer that contains the vector to transform.
*
...
/**
* Return the length of a 3 unsigned integer buffered vector.
*
* @param {Uint32Array} vectorBuffer - Buffer that contains the vector to transform.
* @param {number} vectorBufferOffset - Offset to use when we read the buffer that contains the vector to transform.
*
...
/**
* Set the content of a 3 unsigned integer buffered vector.
*
...
/**
* Multiply a 3 unsigned integer buffered vector with a scalar and put the result in another buffer.
*
...
/**
* Divide a 3 unsigned integer buffered vector with a scalar and put the result in another buffer.
*
* @param {Uint32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
...
/**
* Negate a 3 unsigned integer buffered vector and put the result in another buffer.
*
* @param {Uint32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Uint32Array} resultBuffer - Buffer to write.
...
/**
* Normalize a 3 unsigned integer buffered vector and set the result into another buffer.
*
* @param {Uint32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Uint32Array} resultBuffer - Buffer to write.
...
/**
* Ceil each component of a 3 unsigned integer buffered vector and put the result into another buffer.
*
* @param {Uint32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Uint32Array} resultBuffer - Buffer to write.
...
/**
* Floor each component of a 3 unsigned integer buffered vector and put the result into another buffer.
*
* @param {Uint32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Uint32Array} resultBuffer - Buffer to write.
...
/**
* Round each component of a 3 unsigned integer buffered vector and put the result into another buffer.
*
* @param {Uint32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Uint32Array} resultBuffer - Buffer to write.
...
/**
* Update each component of a 3 unsigned integer buffered vector less than the given minimum, and put the result into another buffer.
*
* @param {Uint32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
...
/**
* Update each component of a 3 unsigned integer buffered vector greather than the given maximum, and put the result into another buffer.
*
* @param {Uint32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
...
/**
* Clamp each component of 3 unsigned integer buffered vector between two values, and put the result into another buffer.
*
* @param {Uint32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {number} minimum - Minimum value allowed.
...
/**
* Compute the a vector that is a mix of two 3 unsigned integer buffered vectors and put the result into another buffer.
*
* @param {Uint32Array} leftBuffer - Buffer that contains the left operand.
* @param {number} leftBufferOffset - Offset to use when we read the buffer that contains the left operand.
* @param {Uint32Array} rightBuffer - Buffer that contains the right operand.
