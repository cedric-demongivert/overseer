/**
* Transform a 3 float buffered vector into a string.
*
* @param {Float32Array} vectorBuffer - Buffer that contains the vector to transform.
...
*
* @param {Float32Array} leftBuffer - Buffer that contains the left operand vector.
* @param {boolean} leftBufferOffset - Offset to use when we read the buffer that contains the left operand vector.
* @param {Float32Array} rightBuffer - Buffer that contains the right operand vector.
...
/**
* Compute the addition of two 3 float buffered vectors and put the result into another buffer.
*
* @param {Float32Array} leftBuffer - Buffer that contains the left operand.
* @param {number} leftBufferOffset - Offset to use when we read the buffer that contains the left operand.
* @param {Float32Array} rightBuffer - Buffer that contains the right operand.
...
*
* @return {Float32Array} The updated result buffer.
*/
export function add (
  leftBuffer,
  leftBufferOffset,
...
*
* @param {Float32Array} vectorBuffer - Buffer to write.
...
*
* @return {Float32Array} The given buffer updated with the new values.
*/
export function set (
  vectorBuffer,
  vectorBufferOffset,
