/**
* Transform a 3 integer buffered vector into a string.
*
...
/**
* Compute the addition of two 3 integer buffered vectors and put the result into another buffer.
*
...
/**
* Normalize a 3 integer buffered vector and set the result into another buffer.
*
* @param {Int32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
...
/**
* Ceil each component of a 3 integer buffered vector and put the result into another buffer.
*
* @param {Int32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
...
/**
* Floor each component of a 3 integer buffered vector and put the result into another buffer.
*
* @param {Int32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
...
/**
* Round each component of a 3 integer buffered vector and put the result into another buffer.
*
* @param {Int32Array} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {Int32Array} resultBuffer - Buffer to write.
