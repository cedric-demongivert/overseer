import vector4f from './raw/vector4f'
...
export class Vector4f {
  ...
  *
  * @return {Vector4f} The new vector instance.
  */
  static create (
    x,
    y,
  ...
  *
  * @param {Vector4f} vector - A 4 float vector to clone.
  *
  * @return {Vector4f} The cloned vector instance.
  */
  static clone (vector) {
    const result = new Vector4f()
    result.x = vector.x
    result.y = vector.y
    result.z = vector.z
    result.w = vector.w
  ...
  */
  get squaredLength () {
    return vector4f.squaredLength(this._buffer, 0)
  }
  ...
  */
  get length () {
    return vector4f.length(this._buffer, 0)
  }
  ...
  * @param w - w component of the new vector
  *
  * @return {Vector4f} This vector instance for chaining purpose.
  */
  set (
    x,
    y,
    ...
    vector4f.set(this._buffer, 0, x, y, z, w)
    return this
  }
  ...
  * @param {Vector4f} [result = this] - The result vector.
  *
  * @return {Vector4f} This vector instance for chaining purpose.
  */
  ...
  */
  dot (left, tolerance = Number.EPSILON) {
    return vector4f.dot(this._buffer, 0, left.buffer, 0)
  }
  ...
  */
  equals (left, tolerance = Number.EPSILON) {
    return vector4f.equals(this._buffer, 0, left.buffer, 0, tolerance)
  }
  ...
  */
  toString () {
    return vector4f.toString(this._buffer, 0)
  }
}