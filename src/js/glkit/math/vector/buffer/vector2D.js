...
/**
* Transform a 2D vector from a buffer into a string.
*
...
export function toString (vectorBuffer, vectorBufferOffset) {
  return vector.toString(vectorBuffer, vectorBufferOffset, 2)
}
...
/**
* Compute the addition of two 2D vector from two buffers and put the result into another buffer.
*
...
/**
* Compute the subtraction of two 2D vector from two buffers and put the result into another buffer.
*
* @param {TypedArray} leftBuffer - Buffer that contains the left operand.
* @param {boolean} leftBufferOffset - Offset to use when we read the buffer that contains the left operand.
* @param {TypedArray} rightBuffer - Buffer that contains the right operand.
...
/**
* Compute the dot product of two 2D vector from two buffers and return the result.
*
* @param {TypedArray} leftBuffer - Buffer that contains the left operand.
* @param {boolean} leftBufferOffset - Offset to use when we read the buffer that contains the left operand.
* @param {TypedArray} rightBuffer - Buffer that contains the right operand.
...
/**
* Return the squared length of a 2D vector from a buffer.
*
* @param {TypedArray} vectorBuffer - Buffer that contains the vector to transform.
* @param {boolean} vectorBufferOffset - Offset to use when we read the buffer that contains the vector to transform.
*
...
/**
* Return the length of a 2D vector from a buffer.
*
* @param {TypedArray} vectorBuffer - Buffer that contains the vector to transform.
* @param {boolean} vectorBufferOffset - Offset to use when we read the buffer that contains the vector to transform.
*
...
/**
* Set the content of a 2D vector in a buffer.
*
...
/**
* Multiply a 2D vector of a buffer with a scalar and put the result in another buffer.
*
...
/**
* Divide a 2D vector of a buffer with a scalar and put the result in another buffer.
*
* @param {TypedArray} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
...
/**
* Negate a 2D vector of a buffer and put the result in another buffer.
*
* @param {TypedArray} vectorBuffer - Buffer to read.
* @param {number} vectorBufferOffset - Offset to use when we read the given buffer.
* @param {TypedArray} [resultBuffer = vectorBuffer] - Buffer to write.
...
export function minimum (
  ...
  return set(
    resultBuffer, resultBufferOffset,
    Math.max(a1, minimum), Math.max(a2, minimum)
  )
}
...
export function maximum (
  ...
  return set(
    resultBuffer, resultBufferOffset,
    Math.min(a1, maximum), Math.min(a2, maximum)
  )
}
