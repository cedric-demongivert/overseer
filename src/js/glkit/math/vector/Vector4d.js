import vector4d from './raw/vector4d'
...
export class Vector4d {
  ...
  *
  * @return {Vector4d} The new vector instance.
  */
  static create (
    x,
    y,
    ...
    return new Vector4d().set(x, y, z, w)
  }
  ...
  *
  * @param {Vector4d} vector - A 4 double vector to clone.
  *
  * @return {Vector4d} The cloned vector instance.
  */
  static clone (vector) {
  ...
  */
  get squaredLength () {
    return vector4d.squaredLength(this._buffer, 0)
  }
  ...
  */
  get length () {
    return vector4d.length(this._buffer, 0)
  }
  ...
  * @param w - w component of the new vector
  *
  * @return {Vector4d} This vector instance for chaining purpose.
  */
  set (
    x,
    y,
    ...
    vector4d.set(this._buffer, 0, x, y, z, w)
    return this
  }
  ...
  * @param {Vector4d} [result = this] - The result vector.
  *
  * @return {Vector4d} This vector instance for chaining purpose.
  */
  ...
  */
  dot (left, tolerance = Number.EPSILON) {
    return vector4d.dot(this._buffer, 0, left.buffer, 0)
  }
  ...
  */
  equals (left, tolerance = Number.EPSILON) {
    return vector4d.equals(this._buffer, 0, left.buffer, 0, tolerance)
  }
  ...
  */
  toString () {
    return vector4d.toString(this._buffer, 0)
  }
}