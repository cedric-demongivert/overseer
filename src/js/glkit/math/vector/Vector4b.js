import vector4b from './raw/vector4b'

export class Vector4b {
  /**
  * Create a new 4 byte vector with initial data.
  *
  ...
  *
  * @return {Vector4b} The new vector instance.
  */
  static create (
    x,
    y,
    ...
    return new Vector4b().set(x, y, z, w)
  }

  /**
  * Wrap a Int8Array as a 4 byte vector.
  *
  ...
  */
  static wrap (buffer) {
    return new Vector4b(buffer)
  }

  /**
  * Clone another 4 byte vector and return the result.
  *
  * @param {Vector4b} vector - A 4 byte vector to clone.
  *
  * @return {Vector4b} The cloned vector instance.
  */
  static clone (vector) {
    const result = new Vector4b()
    result.x = vector.x
    result.y = vector.y
    result.z = vector.z
    result.w = vector.w
  ...
  */
  get squaredLength () {
    return vector4b.squaredLength(this._buffer, 0)
  }
  ...
  */
  get length () {
    return vector4b.length(this._buffer, 0)
  }
  ...
  * @param w - w component of the new vector
  *
  * @return {Vector4b} This vector instance for chaining purpose.
  */
  set (
    x,
    y,
    ...
    vector4b.set(this._buffer, 0, x, y, z, w)
    return this
  }
  ...
  * @param {Vector4b} [result = this] - The result vector.
  *
  * @return {Vector4b} This vector instance for chaining purpose.
  */
  ...
  */
  dot (left, tolerance = Number.EPSILON) {
    return vector4b.dot(this._buffer, 0, left.buffer, 0)
  }
  ...
  */
  equals (left, tolerance = Number.EPSILON) {
    return vector4b.equals(this._buffer, 0, left.buffer, 0, tolerance)
  }
  ...
  */
  toString () {
    return vector4b.toString(this._buffer, 0)
  }
}