import vector3i from './raw/vector3i'
...
export class Vector3i {
  ...
  *
  * @return {Vector3i} The new vector instance.
  */
  static create (
    x,
    y,
  ...
  *
  * @param {Vector3i} vector - A 3 integer vector to clone.
  *
  * @return {Vector3i} The cloned vector instance.
  */
  static clone (vector) {
    const result = new Vector3i()
    result.x = vector.x
    result.y = vector.y
    result.z = vector.z
  ...
  *
  * @param {Int32Array} [buffer = new Int32Array(3)] - A buffer to wrap.
  */
  ...
  */
  get squaredLength () {
    return vector3i.squaredLength(this._buffer, 0)
  }
  ...
  */
  get length () {
    return vector3i.length(this._buffer, 0)
  }
  ...
  * @param z - z component of the new vector
  *
  * @return {Vector3i} This vector instance for chaining purpose.
  */
  set (
    x,
    y,
    ...
    vector3i.set(this._buffer, 0, x, y, z)
    return this
  }
  ...
  * @param {Vector3i} [result = this] - The result vector.
  *
  * @return {Vector3i} This vector instance for chaining purpose.
  */
  ...
  */
  dot (left, tolerance = Number.EPSILON) {
    return vector3i.dot(this._buffer, 0, left.buffer, 0)
  }
  ...
  */
  equals (left, tolerance = Number.EPSILON) {
    return vector3i.equals(this._buffer, 0, left.buffer, 0, tolerance)
  }
  ...
  */
  toString () {
    return vector3i.toString(this._buffer, 0)
  }
}