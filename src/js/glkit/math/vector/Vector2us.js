import vector2us from './raw/vector2us'

export class Vector2us {
  /**
  * Create a new 2 unsigned short vector with initial data.
  *
  * @param x - x component of the new vector
  * @param y - y component of the new vector
  *
  * @return {Vector2us} The new vector instance.
  */
  static create (
    x,
    y
  ) {
    return new Vector2us().set(x, y)
  }

  /**
  * Wrap a Uint16Array as a 2 unsigned short vector.
  *
  ...
  */
  static wrap (buffer) {
    return new Vector2us(buffer)
  }

  /**
  * Clone another 2 unsigned short vector and return the result.
  *
  * @param {Vector2us} vector - A 2 unsigned short vector to clone.
  *
  * @return {Vector2us} The cloned vector instance.
  */
  static clone (vector) {
    const result = new Vector2us()
    result.x = vector.x
    result.y = vector.y
  ...
  /**
  * Create a new 2 unsigned short vector.
  *
  * @param {Uint16Array} [buffer = new Uint16Array(2)] - A buffer to wrap.
  */
  constructor (buffer = new Uint16Array(2)) {
    this._buffer = buffer
  }
  ...
  */
  get squaredLength () {
    return vector2us.squaredLength(this._buffer, 0)
  }
  ...
  */
  get length () {
    return vector2us.length(this._buffer, 0)
  }
  ...
  * @param y - y component of the new vector
  *
  * @return {Vector2us} This vector instance for chaining purpose.
  */
  set (
    x,
    y
  ) {
    vector2us.set(this._buffer, 0, x, y)
    return this
  }
  ...
  * @param {Vector2us} [result = this] - The result vector.
  *
  * @return {Vector2us} This vector instance for chaining purpose.
  */
  ...
  */
  dot (left, tolerance = Number.EPSILON) {
    return vector2us.dot(this._buffer, 0, left.buffer, 0)
  }
  ...
  */
  equals (left, tolerance = Number.EPSILON) {
    return vector2us.equals(this._buffer, 0, left.buffer, 0, tolerance)
  }
  ...
  */
  toString () {
    return vector2us.toString(this._buffer, 0)
  }
}