...
export class Viewport {
  ...
  */
  ...
  /**
  * The entity that hold the camera component used with this viewport.
  */
  public camera : Component<Camera>

  /**
  * The color used for clearing the viewport.
    */
  public readonly background : Vector3f
  ...
  */
  public copy (toCopy : Viewport) : void {
    ...
    this.background.copy(toCopy.background)
  }
